import { IBasicParams, TOrder, WithProofs, WithSender } from './transactions'
import { TPrivateKey, TSeedTypes } from './types'
import { base58Decode, publicKey } from '@waves/ts-lib-crypto'
...
export function normalizeAssetId(assetId: string | null): string {
