 ...
 * @typeparam LONG Generic type representing LONG type. Default to string | number. Since javascript number more than 2 ** 53 -1 cannot be precisely represented, generic type is used
 */
export interface IUpdateAssetInfoTransaction<LONG = string | number> extends ITransaction<LONG>, WithChainId {
 ...
 * @typeparam LONG Generic type representing LONG type. Default to string | number. Since javascript number more than 2 ** 53 -1 cannot be precisely represented, generic type is used
 */
export interface IUpdateAssetInfoParams<LONG = string | number> extends IBasicParams<LONG>, WithChainIdParam {
    assetId: string;
    name: string;
    description: string;
    chainId?: number;
